 ...
 * ================================
 * 
 * Micro-frontend component for visualizing sorting and searching algorithms.
 * This component is part of the Kashif Raza Portfolio application.
 * 
 ...
 * - Audio feedback
 * - Speed control and animation states
 * - Algorithm comparison
 * - Code line highlighting
 * 
 * State Management:
 * - selectedAlgorithm: Currently selected algorithm
 * - speed: Execution speed multiplier (0.5 - 4)
 * - dataSet: Current array being sorted/searched
 * - animationState: Current animation frame state
